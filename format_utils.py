"""
Format utilities for converting between text formats (Markdown, HTML, Wiki).
"""
...
"""
        ...
        logging.error("Markdown library not installed. Install it with: pip install markdown")
